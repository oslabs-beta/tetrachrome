...
import styles from '../stylesheets/_tree.scss';
...
d3.json(treeArr[0], function(error, json){
  ...
  json.child.forEach(function(gen2){
    gen2.child.forEach(function(gen3){
      collapse(gen3);
    });
  });
...
function draw(source){
  ...
  // Update nodes    
  let node = svg.selectAll("g.person")
